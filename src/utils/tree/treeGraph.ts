...
// Unresolved edges are reported, not silently skipped — a season patch that
// breaks topology must be visible (spec §2).
...
export const TREE_GRAPH_WARNINGS: ReadonlyArray<string> = treeGraphWarnings
