...
// Mirrors the hub (src/data/index.ts): every patchable collection is applied
// against its real base data. With no patch files this exercises the empty
// path; a broken patch under src/data/seasons/<id>/ fails npm test here.
